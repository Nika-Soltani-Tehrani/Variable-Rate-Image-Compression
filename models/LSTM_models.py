...
class LSTMEncoder(nn.Module):
    ...
    def forward(self, x, state):
        ...
        bits = torch.sign(F.tanh(self.binaryFC(h_out2)))
...
class LSTMCore(nn.Module):
    ...
    def __init__(self, coded_size=4, patch_size=8, batch_size=4, repetition=16):
    ...
    def forward(self, input_patch):
        ...
        for _ in range(self.repetition):
            ...
            bits.append(bits)
            next_input = next_input - output_patch
...
class ResidualLSTM(nn.Module):
    ...
    def forward(self, input_patch, pass_num):
        ...
        residual_patch = input_patch.clone() - output_patch
